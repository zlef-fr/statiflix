...
(function () {
  ...
  const DICT = {
    en: {
      ...
      'get.title': 'Get Statiflix', 'get.lead': 'Free and open source. Pending Chrome Web Store review — install the unpacked build in 30 seconds:',
      'get.download': 'Download extension (.zip)',
      'get.s1': 'Download and <b>unzip</b> the file.',
      'get.s2': 'Open <code>chrome://extensions</code> and turn on <b>Developer mode</b> (top-right).',
      'get.s3': 'Click <b>Load unpacked</b> and select the unzipped <code>statiflix</code> folder.',
      'get.s4': 'Open <b>netflix.com</b>, click the Statiflix icon, then <b>Analyze my history</b>.',
    ...
    fr: {
      ...
      'get.title': 'Obtenir Statiflix', 'get.lead': 'Gratuit et open source. En attente de validation Chrome Web Store — installez la version locale en 30 secondes :',
      'get.download': 'Télécharger l’extension (.zip)',
      'get.s1': 'Téléchargez puis <b>décompressez</b> le fichier.',
      'get.s2': 'Ouvrez <code>chrome://extensions</code> et activez le <b>Mode développeur</b> (en haut à droite).',
      'get.s3': 'Cliquez sur <b>Charger l’extension non empaquetée</b> et choisissez le dossier <code>statiflix</code>.',
      'get.s4': 'Ouvrez <b>netflix.com</b>, cliquez l’icône Statiflix, puis <b>Analyser mon historique</b>.',
